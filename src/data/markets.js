...
export const marketsData = {
  ...
  lastUpdated: "1 July 2026, 3:55 PM PKT",

  // -- Ticker strip: the 6 headline numbers --
  ticker: [
    // -- AUTO:ticker --
    { name: "KSE-100", value: "184,050", changePct: "+2.08%", direction: "up", spark: [170600.2, 171021.77, 170190.64, 171175.5, 170478.94, 168953.7, 170330.56, 169427.44, 169703.6, 172399.9, 177039.82, 180392.97, 180511.02, 181398.21, 178922.75, 178471.86, 177692.92, 179571.26, 178414.79, 180301.7] },
    { name: "Brent", value: "$72.29", changePct: "-0.86%", direction: "down", spark: [74.08, 74.55, 74.16, 73.46, 72.86, 72.65, 73.05, 73.47, 72.73, 72.81, 72.67, 72.4, 72.65, 72.64, 72.44, 72.8, 73.4, 72.6, 73.25, 73.03, 73.12, 73.19, 73.22, 73.29, 73.21, 72.72, 73.16, 72.73, 73.3, 73.72, 73.04, 73.15, 73.24, 73.29, 73.66, 73.8, 73.97, 74.04, 73.68, 73.75, 73.64, 73.56, 73.51, 73.51, 73.56, 73.89, 73.59, 73.49, 73.33, 73.41, 73.48, 73.69, 74.24, 73.95, 74.42, 74.22, 74.26, 73.94, 73.37, 73.35, 73.16, 73.36, 73.42, 73.37, 73.35, 73.48, 73.51, 73.2, 73.24, 73.24, 73.19, 73.04, 73.09, 72.92, 71.75, 72.18, 72.24] },
    { name: "Dubai Platts", value: "$79.52", changePct: "-22.9%", direction: "down", spark: [] },
    { name: "Gold", value: "$4,001", changePct: "-0.55%", direction: "down", spark: [4026.8, 4023.2, 4047.2, 4046.4, 4046.1, 4062.8, 4069.8, 4061.0, 4074.0, 4088.7, 4095.7, 4106.3, 4099.9, 4089.6, 4082.2, 4086.2, 4096.3, 4080.8, 4076.7, 4083.9, 4075.8, 4080.8, 4083.2, 4065.7, 4069.0, 4077.0, 4076.3, 4060.9, 4045.8, 4051.1, 4053.3, 4057.8, 4046.4, 4039.5, 4041.5, 4038.4, 4035.3, 4027.8, 4030.4, 4030.5, 4028.4, 4029.4, 4001.3, 3982.7, 3975.8, 3983.8, 3999.2, 3991.1, 4043.5, 4046.3, 4029.0, 4038.0, 4043.9, 4047.5, 4023.9, 4043.9, 4052.0, 4044.2, 4040.3, 4045.5, 4043.6, 4030.2, 4021.8, 4026.4, 4018.9, 4010.2, 3990.8, 3991.9, 3992.9, 3989.2, 3986.6, 3985.0, 3988.7, 3987.7, 3997.9, 4000.8] },
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$71.99", current: "$72.24", change: "+0.35%", direction: "up" },
      { name: "WTI crude", prev: "$69.23", current: "$68.80", change: "-0.62%", direction: "down" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,079", current: "$4,001", change: "-1.91%", direction: "down" },
      { name: "Silver", prev: "$59.22", current: "$58.45", change: "-1.30%", direction: "down" },
      ...
      { name: "EUR / USD", prev: "1.1395", current: "1.1403", change: "+0.07%", direction: "up" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$72.29", unit: "/bbl", open: "73.38", high: "73.52", low: "71.63" },
      { name: "WTI Crude Oil", value: "$68.84", unit: "/bbl", open: "69.98", high: "70.19", low: "68.22" },
      { name: "Natural Gas", value: "$3.2350", unit: "/MMBtu", open: "3.2560", high: "3.2590", low: "3.2140" },
      { name: "Gold", value: "$4,001", unit: "/oz", open: "4,025", high: "4,032", low: "3,973" },
      { name: "Silver", value: "$58.44", unit: "/oz", open: "59.25", high: "59.34", low: "57.56" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,355", open: "8,392", range: "8,352 – 8,392", region: "Europe" },
      { name: "DAX", close: "25,065", open: "25,029", range: "24,956 – 25,096", region: "Europe" },
      { name: "FTSE 100", close: "10,455", open: "10,498", range: "10,443 – 10,508", region: "Europe" },
      { name: "Stoxx 600", close: "639.92", open: "641.59", range: "638.56 – 641.61", region: "Europe" },
      ...
      { name: "EUR / USD", close: "1.1403", open: "1.1427", range: "1.1390 – 1.1429", region: "Currencies" },
      { name: "GBP / USD", close: "1.3256", open: "1.3262", range: "1.3230 – 1.3263", region: "Currencies" },
      { name: "USD / CNY", close: "6.7816", open: "6.7783", range: "6.7765 – 6.7967", region: "Currencies" },
