...
export const marketsData = {
  ...
  lastUpdated: "26 June 2026, 1:18 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$73.42", change: "-8.90%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$69.77", change: "-10.02%", direction: "down" },
      ...
      { name: "Silver", prev: "$66.25", current: "$58.22", change: "-12.13%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.33", change: "+4.07%", direction: "up" },
      { name: "USD / PKR", prev: "278.00", current: "277.70", change: "-0.11%", direction: "down" },
      { name: "EUR / USD", prev: "1.1480", current: "1.1403", change: "-0.67%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$73.42", unit: "/bbl", open: "75.02", high: "75.46", low: "73.37" },
      { name: "WTI Crude Oil", value: "$69.78", unit: "/bbl", open: "71.44", high: "71.86", low: "69.76" },
      { name: "Natural Gas", value: "$3.3280", unit: "/MMBtu", open: "3.2670", high: "3.3390", low: "3.2610" },
      { name: "Gold", value: "$4,046", unit: "/oz", open: "4,044", high: "4,056", low: "3,998" },
      { name: "Silver", value: "$58.22", unit: "/oz", open: "58.03", high: "58.33", low: "55.69" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,400", open: "8,410", range: "8,396 – 8,421", region: "Europe" },
      { name: "DAX", close: "24,798", open: "24,849", range: "24,792 – 24,870", region: "Europe" },
      { name: "FTSE 100", close: "10,490", open: "10,530", range: "10,477 – 10,530", region: "Europe" },
      { name: "Stoxx 600", close: "636.69", open: "639.03", range: "636.58 – 639.03", region: "Europe" },
      { name: "Hang Seng", close: "22,684", open: "22,952", range: "22,518 – 22,962", region: "Asia" },
      ...
      { name: "EUR / USD", close: "1.1403", open: "1.1378", range: "1.1357 – 1.1403", region: "Currencies" },
      { name: "GBP / USD", close: "1.3213", open: "1.3197", range: "1.3181 – 1.3213", region: "Currencies" },
      { name: "USD / CNY", close: "6.8007", open: "6.7892", range: "6.7851 – 6.8035", region: "Currencies" },
