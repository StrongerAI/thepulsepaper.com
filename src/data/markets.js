...
export const marketsData = {
  ...
  lastUpdated: "25 June 2026, 11:59 AM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$72.55", change: "-9.98%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$69.52", change: "-10.34%", direction: "down" },
      { name: "Dubai Platts", prev: "$110", current: "$103.15", change: "-6.2%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$3,998", change: "-3.55%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$56.93", change: "-14.07%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.29", change: "+2.81%", direction: "up" },
      { name: "USD / PKR", prev: "278.00", current: "277.70", change: "-0.11%", direction: "down" },
      { name: "EUR / USD", prev: "1.1480", current: "1.1357", change: "-1.07%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$72.55", unit: "/bbl", open: "73.10", high: "73.51", low: "72.27" },
      { name: "WTI Crude Oil", value: "$69.52", unit: "/bbl", open: "69.95", high: "70.21", low: "69.05" },
      { name: "Natural Gas", value: "$3.2880", unit: "/MMBtu", open: "3.2630", high: "3.2920", low: "3.2560" },
      { name: "Gold", value: "$3,997", unit: "/oz", open: "4,019", high: "4,034", low: "3,976" },
      { name: "Silver", value: "$56.90", unit: "/oz", open: "57.60", high: "57.96", low: "56.40" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "Sensex", close: "77,743", open: "77,391", range: "77,280 – 77,803", region: "Asia" },
      { name: "Shanghai Comp.", close: "4,116", open: "4,103", range: "4,093 – 4,133", region: "Asia" },
      { name: "EUR / USD", close: "1.1357", open: "1.1361", range: "1.1352 – 1.1374", region: "Currencies" },
      { name: "GBP / USD", close: "1.3173", open: "1.3168", range: "1.3159 – 1.3186", region: "Currencies" },
      { name: "USD / CNY", close: "6.7900", open: "6.7900", range: "6.7900 – 6.7900", region: "Currencies" },
