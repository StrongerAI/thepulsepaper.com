...
export const marketsData = {
  ...
  lastUpdated: "25 June 2026, 12:01 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "WTI crude", prev: "$77.54", current: "$69.59", change: "-10.25%", direction: "down" },
      { name: "Dubai Platts", prev: "$110", current: "$103.15", change: "-6.2%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$3,997", change: "-3.57%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$56.94", change: "-14.06%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.29", change: "+2.78%", direction: "up" },
  ...
  commodities: {
    rows: [
      ...
      { name: "WTI Crude Oil", value: "$69.56", unit: "/bbl", open: "69.95", high: "70.21", low: "69.05" },
      { name: "Natural Gas", value: "$3.2860", unit: "/MMBtu", open: "3.2630", high: "3.2920", low: "3.2560" },
      { name: "Gold", value: "$3,998", unit: "/oz", open: "4,019", high: "4,034", low: "3,976" },
      { name: "Silver", value: "$56.97", unit: "/oz", open: "57.60", high: "57.96", low: "56.40" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "Hang Seng", close: "23,022", open: "23,388", range: "22,992 – 23,388", region: "Asia" },
      ...
      { name: "Sensex", close: "77,759", open: "77,391", range: "77,280 – 77,803", region: "Asia" },
      { name: "Shanghai Comp.", close: "4,115", open: "4,103", range: "4,093 – 4,133", region: "Asia" },
      { name: "EUR / USD", close: "1.1358", open: "1.1361", range: "1.1352 – 1.1374", region: "Currencies" },
      { name: "GBP / USD", close: "1.3174", open: "1.3168", range: "1.3159 – 1.3186", region: "Currencies" },
