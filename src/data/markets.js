...
export const marketsData = {
  ...
  lastUpdated: "25 June 2026, 12:41 AM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$73.33", change: "-9.01%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$70.07", change: "-9.63%", direction: "down" },
      { name: "Dubai Platts", prev: "$110", current: "$103.15", change: "-6.2%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$4,002", change: "-3.46%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$56.92", change: "-14.09%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.26", change: "+1.94%", direction: "up" },
      ...
      { name: "S&P 500", prev: "7,501", current: "7,342", change: "-2.12%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$73.33", unit: "/bbl", open: "77.00", high: "77.00", low: "73.08" },
      { name: "WTI Crude Oil", value: "$70.08", unit: "/bbl", open: "73.13", high: "73.18", low: "69.63" },
      { name: "Natural Gas", value: "$3.2600", unit: "/MMBtu", open: "3.2000", high: "3.2700", low: "3.1770" },
      { name: "Gold", value: "$4,001", unit: "/oz", open: "4,130", high: "4,132", low: "3,976" },
      { name: "Silver", value: "$56.88", unit: "/oz", open: "61.63", high: "62.44", low: "55.75" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "Dow Jones", close: "51,775", open: "51,661", range: "51,618 – 52,249", region: "Americas" },
      { name: "Nasdaq", close: "25,426", open: "25,579", range: "25,355 – 25,841", region: "Americas" },
      { name: "S&P 500", close: "7,343", open: "7,371", range: "7,337 – 7,428", region: "Americas" },
      ...
      { name: "EUR / USD", close: "1.1358", open: "1.1388", range: "1.1329 – 1.1390", region: "Currencies" },
      { name: "GBP / USD", close: "1.3161", open: "1.3203", range: "1.3140 – 1.3209", region: "Currencies" },
      { name: "USD / CNY", close: "6.8014", open: "6.7895", range: "6.7757 – 6.8104", region: "Currencies" },
