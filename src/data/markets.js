...
export const marketsData = {
  ...
  lastUpdated: "26 June 2026, 3:37 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$72.82", change: "-9.64%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$69.31", change: "-10.61%", direction: "down" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$4,060", change: "-2.05%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$58.56", change: "-11.61%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.34", change: "+4.38%", direction: "up" },
      { name: "USD / PKR", prev: "278.00", current: "277.70", change: "-0.11%", direction: "down" },
      { name: "EUR / USD", prev: "1.1480", current: "1.1408", change: "-0.63%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$72.82", unit: "/bbl", open: "75.02", high: "75.46", low: "72.47" },
      { name: "WTI Crude Oil", value: "$69.30", unit: "/bbl", open: "71.44", high: "71.86", low: "68.96" },
      { name: "Natural Gas", value: "$3.3380", unit: "/MMBtu", open: "3.2670", high: "3.3440", low: "3.2610" },
      { name: "Gold", value: "$4,061", unit: "/oz", open: "4,044", high: "4,070", low: "3,998" },
      { name: "Silver", value: "$58.56", unit: "/oz", open: "58.03", high: "58.88", low: "56.13" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,376", open: "8,410", range: "8,375 – 8,421", region: "Europe" },
      { name: "DAX", close: "24,685", open: "24,849", range: "24,677 – 24,870", region: "Europe" },
      { name: "FTSE 100", close: "10,446", open: "10,530", range: "10,446 – 10,530", region: "Europe" },
      { name: "Stoxx 600", close: "634.30", open: "639.03", range: "634.07 – 639.03", region: "Europe" },
      ...
      { name: "EUR / USD", close: "1.1408", open: "1.1378", range: "1.1357 – 1.1416", region: "Currencies" },
      { name: "GBP / USD", close: "1.3220", open: "1.3197", range: "1.3181 – 1.3229", region: "Currencies" },
      { name: "USD / CNY", close: "6.7890", open: "6.7892", range: "6.7851 – 6.8035", region: "Currencies" },
