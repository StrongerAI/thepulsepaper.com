...
export const marketsData = {
  ...
  lastUpdated: "25 June 2026, 1:01 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$73.30", change: "-9.05%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$69.87", change: "-9.89%", direction: "down" },
      { name: "Dubai Platts", prev: "$110", current: "$103.15", change: "-6.2%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$3,993", change: "-3.68%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$56.88", change: "-14.15%", direction: "down" },
      ...
      { name: "EUR / USD", prev: "1.1480", current: "1.1366", change: "-0.99%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$73.26", unit: "/bbl", open: "73.10", high: "73.51", low: "72.27" },
      { name: "WTI Crude Oil", value: "$69.85", unit: "/bbl", open: "69.95", high: "70.21", low: "69.05" },
      { name: "Natural Gas", value: "$3.3230", unit: "/MMBtu", open: "3.2630", high: "3.3250", low: "3.2560" },
      { name: "Gold", value: "$3,992", unit: "/oz", open: "4,019", high: "4,034", low: "3,976" },
      { name: "Silver", value: "$56.88", unit: "/oz", open: "57.60", high: "57.96", low: "56.40" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,391", open: "8,389", range: "8,374 – 8,396", region: "Europe" },
      { name: "DAX", close: "24,826", open: "24,810", range: "24,762 – 24,844", region: "Europe" },
      { name: "FTSE 100", close: "10,472", open: "10,462", range: "10,415 – 10,479", region: "Europe" },
      { name: "Stoxx 600", close: "637.83", open: "635.68", range: "635.68 – 638.23", region: "Europe" },
      { name: "Hang Seng", close: "23,035", open: "23,388", range: "22,979 – 23,388", region: "Asia" },
      ...
      { name: "Sensex", close: "77,505", open: "77,391", range: "77,280 – 77,803", region: "Asia" },
      { name: "Shanghai Comp.", close: "4,120", open: "4,103", range: "4,093 – 4,133", region: "Asia" },
      { name: "EUR / USD", close: "1.1366", open: "1.1361", range: "1.1349 – 1.1374", region: "Currencies" },
      { name: "GBP / USD", close: "1.3188", open: "1.3168", range: "1.3159 – 1.3188", region: "Currencies" },
      { name: "USD / CNY", close: "6.7990", open: "6.8101", range: "6.7898 – 6.8122", region: "Currencies" },
