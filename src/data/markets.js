...
export const marketsData = {
  ...
  lastUpdated: "26 June 2026, 4:00 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$72.99", change: "-9.43%", direction: "down" },
      ...
      { name: "Gold", prev: "$4,145", current: "$4,064", change: "-1.96%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$58.76", change: "-11.32%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.34", change: "+4.47%", direction: "up" },
      { name: "USD / PKR", prev: "278.00", current: "277.70", change: "-0.11%", direction: "down" },
      { name: "EUR / USD", prev: "1.1480", current: "1.1409", change: "-0.62%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$72.99", unit: "/bbl", open: "75.02", high: "75.46", low: "72.47" },
      { name: "WTI Crude Oil", value: "$69.46", unit: "/bbl", open: "71.44", high: "71.86", low: "68.96" },
      { name: "Natural Gas", value: "$3.3410", unit: "/MMBtu", open: "3.2670", high: "3.3460", low: "3.2610" },
      { name: "Gold", value: "$4,064", unit: "/oz", open: "4,044", high: "4,070", low: "3,998" },
      { name: "Silver", value: "$58.76", unit: "/oz", open: "58.03", high: "58.88", low: "56.13" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,377", open: "8,410", range: "8,372 – 8,421", region: "Europe" },
      { name: "DAX", close: "24,680", open: "24,849", range: "24,668 – 24,870", region: "Europe" },
      { name: "FTSE 100", close: "10,452", open: "10,530", range: "10,442 – 10,530", region: "Europe" },
      { name: "Stoxx 600", close: "634.15", open: "639.03", range: "634.03 – 639.03", region: "Europe" },
      ...
      { name: "EUR / USD", close: "1.1409", open: "1.1378", range: "1.1357 – 1.1416", region: "Currencies" },
      { name: "GBP / USD", close: "1.3223", open: "1.3197", range: "1.3181 – 1.3229", region: "Currencies" },
      { name: "USD / CNY", close: "6.7886", open: "6.7892", range: "6.7851 – 6.8035", region: "Currencies" },
