...
export const marketsData = {
  ...
  lastUpdated: "2 July 2026, 9:45 AM PKT",

  // -- Ticker strip: the 6 headline numbers --
  ticker: [
    // -- AUTO:ticker --
    { name: "KSE-100", value: "184,859", changePct: "+0.44%", direction: "up", spark: [171021.77, 170190.64, 171175.5, 170478.94, 168953.7, 170330.56, 169427.44, 169703.6, 172399.9, 177039.82, 180392.97, 180511.02, 181398.21, 178922.75, 178471.86, 177692.92, 179571.26, 178414.79, 180301.7, 184050.1] },
    { name: "Brent", value: "$70.90", changePct: "-0.94%", direction: "down", spark: [73.25, 73.03, 73.12, 73.19, 73.22, 73.29, 73.21, 72.72, 73.16, 72.73, 73.3, 73.72, 73.04, 73.15, 73.24, 73.29, 73.66, 73.8, 73.97, 74.04, 73.68, 73.75, 73.64, 73.56, 73.51, 73.51, 73.56, 73.89, 73.59, 73.49, 73.33, 73.41, 73.48, 73.69, 74.24, 73.95, 74.42, 74.22, 74.26, 73.94, 73.37, 73.35, 73.16, 73.36, 73.42, 73.37, 73.35, 73.48, 73.51, 73.2, 73.24, 73.24, 70.9] },
    { name: "Dubai Platts", value: "$79.52", changePct: "-22.9%", direction: "down", spark: [] },
    { name: "Gold", value: "$4,075", changePct: "+0.16%", direction: "up", spark: [4080.8, 4076.7, 4083.9, 4075.8, 4080.8, 4083.2, 4065.7, 4069.0, 4077.0, 4076.3, 4060.9, 4045.8, 4051.1, 4053.3, 4057.8, 4046.4, 4039.5, 4041.5, 4038.4, 4035.3, 4027.8, 4030.4, 4030.5, 4028.4, 4029.4, 4001.3, 3982.7, 3975.8, 3983.8, 3999.2, 3991.1, 4043.5, 4046.3, 4029.0, 4038.0, 4043.9, 4047.5, 4023.9, 4043.9, 4052.0, 4044.2, 4040.3, 4045.5, 4043.6, 4030.2, 4021.8, 4026.4, 4018.9, 4010.2, 3990.8, 3991.9, 3992.9, 4074.7] },
    { name: "USD/PKR", value: "278.03", changePct: "Flat", direction: "flat", spark: [277.92, 277.92, 277.7, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.7, 277.87, 277.87, 277.9, 277.9, 277.97, 277.97, 278.04, 277.92, 277.92, 277.92, 277.92, 277.8, 277.92, 278.07, 277.93, 277.69, 277.9, 277.72, 277.73, 277.73, 277.73, 277.92, 277.92, 277.92, 277.92, 277.92, 278.0, 278.0, 277.69, 277.72, 277.93, 277.92, 277.92, 277.92, 277.92, 277.88, 278.0, 277.88, 277.88, 277.88, 278.03, 278.03] },
  ...
  weekOverWeek: {
    rows: [
      // -- AUTO:wow-rows --
      { name: "KSE-100", prev: "179,571", current: "184,859", change: "+2.94%", direction: "up" },
      { name: "Brent crude", prev: "$71.99", current: "$70.90", change: "-1.51%", direction: "down" },
      { name: "WTI crude", prev: "$69.23", current: "$67.87", change: "-1.96%", direction: "down" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,079", current: "$4,075", change: "-0.10%", direction: "down" },
      { name: "Silver", prev: "$59.22", current: "$60.53", change: "+2.23%", direction: "up" },
      { name: "Natural Gas", prev: "$3.23", current: "$3.20", change: "-1.02%", direction: "down" },
      { name: "USD / PKR", prev: "277.70", current: "278.03", change: "+0.12%", direction: "up" },
      { name: "EUR / USD", prev: "1.1395", current: "1.1390", change: "Flat", direction: "flat" },
  ...
  psx: {
    headline: [
      // -- AUTO:psx-headline --
      { name: "KSE-100", value: "184,859", change: "+809 (+0.44%)", high: "", low: "", direction: "up" },
      { name: "KSE-30", value: "55,203", change: "+259 (+0.47%)", high: "", low: "", direction: "up" },
      { name: "KMI-30", value: "261,331", change: "+697 (+0.27%)", high: "", low: "", direction: "up" },
      { name: "All Share", value: "111,292", change: "+502 (+0.45%)", high: "", low: "", direction: "up" },
    // -- /AUTO:psx-headline --
    ],
    sector: [
      // -- AUTO:psx-sector --
      { name: "BKTI (Banks)", value: "51,978", change: "+354 (+0.69%)", high: "", low: "", direction: "up" },
      { name: "OGTI (Oil & Gas)", value: "37,007", change: "+64 (+0.17%)", high: "", low: "", direction: "up" },
      { name: "ACI (Consumer)", value: "24,823", change: "+183 (+0.74%)", high: "", low: "", direction: "up" },
      { name: "JSGBKTI", value: "77,936", change: "+373 (+0.48%)", high: "", low: "", direction: "up" },
    // -- /AUTO:psx-sector --
    ],
    thematic: [
      // -- AUTO:psx-thematic --
      { name: "KMI All Share", value: "71,605", change: "+227 (+0.32%)", direction: "up" },
      { name: "PSX Div 20", value: "85,078", change: "+430 (+0.51%)", direction: "up" },
      { name: "Meezan Pak (MZNPI)", value: "32,287", change: "+93 (+0.29%)", direction: "up" },
      { name: "MII-30 (Islamic)", value: "23,876", change: "+62 (+0.26%)", direction: "up" },
      { name: "NIT Gateway", value: "49,151", change: "+198 (+0.40%)", direction: "up" },
      { name: "NBP Growth", value: "52,995", change: "+199 (+0.38%)", direction: "up" },
      { name: "JS Momentum", value: "44,102", change: "+359 (+0.82%)", direction: "up" },
    // -- /AUTO:psx-thematic --
    ],
    // -- AUTO:commentary-psx --
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$70.90", unit: "/bbl", open: "71.09", high: "71.23", low: "70.64" },
      { name: "WTI Crude Oil", value: "$67.87", unit: "/bbl", open: "68.03", high: "68.17", low: "67.56" },
      { name: "Natural Gas", value: "$3.1980", unit: "/MMBtu", open: "3.2140", high: "3.2140", low: "3.1890" },
      { name: "Gold", value: "$4,075", unit: "/oz", open: "4,049", high: "4,086", low: "4,043" },
      { name: "Silver", value: "$60.53", unit: "/oz", open: "59.75", high: "60.87", low: "59.42" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "Hang Seng", close: "23,154", open: "23,071", range: "22,983 – 23,336", region: "Asia" },
      { name: "KOSPI", close: "7,891", open: "7,933", range: "7,724 – 8,136", region: "Asia" },
      { name: "Nikkei 225", close: "69,273", open: "70,040", range: "68,676 – 70,081", region: "Asia" },
      { name: "Sensex", close: "77,337", open: "77,083", range: "77,064 – 77,449", region: "Asia" },
      { name: "Shanghai Comp.", close: "4,075", open: "4,054", range: "4,043 – 4,094", region: "Asia" },
      { name: "EUR / USD", close: "1.1390", open: "1.1382", range: "1.1378 – 1.1392", region: "Currencies" },
      { name: "GBP / USD", close: "1.3286", open: "1.3283", range: "1.3275 – 1.3295", region: "Currencies" },
      { name: "USD / CNY", close: "6.7843", open: "6.7938", range: "6.7726 – 6.7947", region: "Currencies" },
      { name: "USD / PKR", close: "278.03", open: "", range: "SBP interbank", region: "Currencies", muted: true },
    // -- /AUTO:international-rows --
    ],
