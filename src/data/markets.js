...
export const marketsData = {
  ...
  lastUpdated: "30 June 2026, 12:51 AM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$71.99", current: "$73.63", change: "+2.28%", direction: "up" },
      { name: "WTI crude", prev: "$69.23", current: "$70.42", change: "+1.72%", direction: "up" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,079", current: "$4,032", change: "-1.15%", direction: "down" },
      { name: "Silver", prev: "$59.22", current: "$58.68", change: "-0.91%", direction: "down" },
      { name: "Natural Gas", prev: "$3.23", current: "$3.18", change: "-1.64%", direction: "down" },
      ...
      { name: "S&P 500", prev: "7,354", current: "7,433", change: "+1.07%", direction: "up" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$73.63", unit: "/bbl", open: "73.60", high: "74.24", low: "72.58" },
      { name: "WTI Crude Oil", value: "$70.42", unit: "/bbl", open: "70.50", high: "71.15", low: "69.32" },
      { name: "Natural Gas", value: "$3.1780", unit: "/MMBtu", open: "3.2810", high: "3.3130", low: "3.1630" },
      { name: "Gold", value: "$4,032", unit: "/oz", open: "4,101", high: "4,103", low: "4,012" },
      { name: "Silver", value: "$58.68", unit: "/oz", open: "59.30", high: "59.92", low: "57.84" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "Dow Jones", close: "52,177", open: "51,995", range: "51,950 – 52,312", region: "Americas" },
      { name: "Nasdaq", close: "25,792", open: "25,502", range: "25,290 – 25,826", region: "Americas" },
      { name: "S&P 500", close: "7,434", open: "7,392", range: "7,349 – 7,441", region: "Americas" },
      ...
      { name: "GBP / USD", close: "1.3262", open: "1.3206", range: "1.3192 – 1.3262", region: "Currencies" },
      { name: "USD / CNY", close: "6.7931", open: "6.7897", range: "6.7786 – 6.8042", region: "Currencies" },
