...
export const marketsData = {
  ...
  lastUpdated: "30 June 2026, 3:43 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "WTI crude", prev: "$69.23", current: "$70.84", change: "+2.33%", direction: "up" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,079", current: "$4,040", change: "-0.94%", direction: "down" },
      { name: "Silver", prev: "$59.22", current: "$59.29", change: "+0.13%", direction: "up" },
      { name: "Natural Gas", prev: "$3.23", current: "$3.23", change: "Flat", direction: "flat" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$74.08", unit: "/bbl", open: "73.65", high: "74.38", low: "73.06" },
      { name: "WTI Crude Oil", value: "$70.87", unit: "/bbl", open: "70.43", high: "71.18", low: "69.75" },
      { name: "Natural Gas", value: "$3.2310", unit: "/MMBtu", open: "3.1710", high: "3.2380", low: "3.1590" },
      { name: "Gold", value: "$4,040", unit: "/oz", open: "4,032", high: "4,052", low: "3,955" },
      { name: "Silver", value: "$59.29", unit: "/oz", open: "58.77", high: "60.08", low: "57.06" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,415", open: "8,378", range: "8,372 – 8,419", region: "Europe" },
      { name: "DAX", close: "24,968", open: "24,815", range: "24,795 – 24,969", region: "Europe" },
      { name: "FTSE 100", close: "10,593", open: "10,484", range: "10,484 – 10,599", region: "Europe" },
      { name: "Stoxx 600", close: "643.01", open: "638.28", range: "638.28 – 643.13", region: "Europe" },
      ...
      { name: "EUR / USD", close: "1.1401", open: "1.1430", range: "1.1387 – 1.1430", region: "Currencies" },
      { name: "GBP / USD", close: "1.3236", open: "1.3258", range: "1.3222 – 1.3262", region: "Currencies" },
      { name: "USD / CNY", close: "6.7738", open: "6.7868", range: "6.7702 – 6.7926", region: "Currencies" },
