...
export const marketsData = {
  ...
  lastUpdated: "25 June 2026, 4:00 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$73.12", change: "-9.27%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$69.58", change: "-10.27%", direction: "down" },
      { name: "Dubai Platts", prev: "$110", current: "$103.15", change: "-6.2%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$4,000", change: "-3.50%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$57.42", change: "-13.33%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.32", change: "+3.75%", direction: "up" },
      { name: "USD / PKR", prev: "278.00", current: "277.61", change: "-0.14%", direction: "down" },
      { name: "EUR / USD", prev: "1.1480", current: "1.1348", change: "-1.15%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$73.12", unit: "/bbl", open: "73.10", high: "73.72", low: "72.43" },
      { name: "WTI Crude Oil", value: "$69.60", unit: "/bbl", open: "69.95", high: "70.21", low: "68.90" },
      { name: "Natural Gas", value: "$3.3180", unit: "/MMBtu", open: "3.2630", high: "3.3410", low: "3.2560" },
      { name: "Gold", value: "$4,000", unit: "/oz", open: "4,019", high: "4,034", low: "3,976" },
      { name: "Silver", value: "$57.43", unit: "/oz", open: "57.60", high: "57.96", low: "56.40" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,426", open: "8,389", range: "8,374 – 8,433", region: "Europe" },
      { name: "DAX", close: "24,907", open: "24,810", range: "24,762 – 24,925", region: "Europe" },
      { name: "FTSE 100", close: "10,494", open: "10,462", range: "10,415 – 10,506", region: "Europe" },
      { name: "Stoxx 600", close: "638.96", open: "635.68", range: "635.68 – 639.43", region: "Europe" },
      ...
      { name: "EUR / USD", close: "1.1348", open: "1.1361", range: "1.1347 – 1.1375", region: "Currencies" },
      { name: "GBP / USD", close: "1.3168", open: "1.3168", range: "1.3159 – 1.3197", region: "Currencies" },
      { name: "USD / CNY", close: "6.7891", open: "6.8101", range: "6.7860 – 6.8122", region: "Currencies" },
