...
export const marketsData = {
  ...
  lastUpdated: "30 June 2026, 9:45 AM PKT",

  // -- Ticker strip: the 6 headline numbers --
  ticker: [
    // -- AUTO:ticker --
    { name: "KSE-100", value: "179,480", changePct: "+0.60%", direction: "up", spark: [173962.81, 170600.2, 171021.77, 170190.64, 171175.5, 170478.94, 168953.7, 170330.56, 169427.44, 169703.6, 172399.9, 177039.82, 180392.97, 180511.02, 181398.21, 178922.75, 178471.86, 177692.92, 179571.26, 178414.79] },
    { name: "Brent", value: "$73.54", changePct: "+0.53%", direction: "up", spark: [72.71, 72.46, 72.63, 73.37, 72.71, 72.97, 72.94, 73.42, 73.18, 74.0, 74.27, 74.96, 75.03, 75.24, 75.73, 75.6, 75.0, 75.06, 75.17, 75.39, 74.83, 74.38, 74.22, 74.08, 74.55, 74.16, 73.46, 72.86, 72.65, 73.05, 73.47, 72.73, 72.81, 72.67, 72.4, 72.65, 72.64, 72.44, 72.8, 73.4, 72.6, 73.25, 73.03, 73.12, 73.19, 73.22, 73.29, 73.21, 72.72, 73.16, 72.73, 73.3, 73.72, 73.04, 73.15, 73.24, 73.29, 73.66, 73.8, 73.97, 74.04, 73.68, 73.75, 73.64, 73.56, 73.51, 73.51, 73.59, 73.54] },
    { name: "Dubai Platts", value: "$79.52", changePct: "-22.9%", direction: "down", spark: [] },
    { name: "Gold", value: "$4,008", changePct: "-0.36%", direction: "down", spark: [4011.8, 4001.6, 3992.7, 4003.5, 4004.9, 4003.4, 3999.5, 3995.3, 4028.2, 4017.5, 4027.6, 4057.5, 4044.0, 4050.2, 4050.4, 4041.6, 4041.6, 4041.4, 4030.2, 4035.1, 4035.9, 4006.0, 4018.6, 4026.8, 4023.2, 4047.2, 4046.4, 4046.1, 4062.8, 4069.8, 4061.0, 4074.0, 4088.7, 4095.7, 4106.3, 4099.9, 4089.6, 4082.2, 4086.2, 4096.3, 4080.8, 4076.7, 4083.9, 4075.8, 4080.8, 4083.2, 4065.7, 4069.0, 4077.0, 4076.3, 4060.9, 4045.8, 4051.1, 4053.3, 4057.8, 4046.4, 4039.5, 4041.5, 4038.4, 4035.3, 4027.8, 4030.4, 4030.5, 4028.4, 4029.4, 4001.3, 3982.3, 4008.5] },
    { name: "USD/PKR", value: "277.93", changePct: "Flat", direction: "flat", spark: [277.93, 277.93, 277.93, 278.08, 277.89, 278.04, 278.04, 277.87, 277.89, 277.89, 278.04, 277.92, 277.92, 277.92, 277.92, 277.7, 277.92, 277.92, 277.92, 277.92, 278.05, 277.78, 277.78, 277.7, 277.61, 277.61, 277.61, 277.61, 277.92, 277.92, 277.92, 277.92, 277.92, 277.7, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.92, 277.7, 277.87, 277.87, 277.9, 277.9, 277.97, 277.97, 278.04, 277.92, 277.92, 277.92, 277.92, 277.8, 277.92, 278.07, 277.93] },
  ...
  weekOverWeek: {
    rows: [
      // -- AUTO:wow-rows --
      { name: "KSE-100", prev: "179,571", current: "179,480", change: "-0.05%", direction: "down" },
      { name: "Brent crude", prev: "$71.99", current: "$73.54", change: "+2.15%", direction: "up" },
      { name: "WTI crude", prev: "$69.23", current: "$70.27", change: "+1.50%", direction: "up" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,079", current: "$4,008", change: "-1.72%", direction: "down" },
      { name: "Silver", prev: "$59.22", current: "$58.32", change: "-1.51%", direction: "down" },
      { name: "Natural Gas", prev: "$3.23", current: "$3.17", change: "-1.86%", direction: "down" },
      { name: "USD / PKR", prev: "277.70", current: "277.93", change: "+0.08%", direction: "up" },
  ...
  psx: {
    headline: [
      // -- AUTO:psx-headline --
      { name: "KSE-100", value: "179,480", change: "+1,065 (+0.60%)", high: "", low: "", direction: "up" },
      { name: "KSE-30", value: "53,441", change: "+328 (+0.62%)", high: "", low: "", direction: "up" },
      { name: "KMI-30", value: "255,941", change: "+1,740 (+0.68%)", high: "", low: "", direction: "up" },
      { name: "All Share", value: "108,693", change: "+713 (+0.66%)", high: "", low: "", direction: "up" },
    // -- /AUTO:psx-headline --
    ],
    sector: [
      // -- AUTO:psx-sector --
      { name: "BKTI (Banks)", value: "48,578", change: "+243 (+0.50%)", high: "", low: "", direction: "up" },
      { name: "OGTI (Oil & Gas)", value: "37,044", change: "+289 (+0.79%)", high: "", low: "", direction: "up" },
      { name: "ACI (Consumer)", value: "24,453", change: "+159 (+0.65%)", high: "", low: "", direction: "up" },
      { name: "JSGBKTI", value: "73,420", change: "+401 (+0.55%)", high: "", low: "", direction: "up" },
    // -- /AUTO:psx-sector --
    ],
    thematic: [
      // -- AUTO:psx-thematic --
      { name: "KMI All Share", value: "70,593", change: "+417 (+0.59%)", direction: "up" },
      { name: "PSX Div 20", value: "82,777", change: "+510 (+0.62%)", direction: "up" },
      { name: "Meezan Pak (MZNPI)", value: "31,548", change: "+218 (+0.69%)", direction: "up" },
      { name: "MII-30 (Islamic)", value: "23,421", change: "+155 (+0.66%)", direction: "up" },
      { name: "NIT Gateway", value: "47,310", change: "+292 (+0.62%)", direction: "up" },
      { name: "NBP Growth", value: "51,431", change: "+325 (+0.64%)", direction: "up" },
      { name: "JS Momentum", value: "43,111", change: "+337 (+0.79%)", direction: "up" },
    // -- /AUTO:psx-thematic --
    ],
    // -- AUTO:commentary-psx --
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$73.54", unit: "/bbl", open: "73.65", high: "74.06", low: "73.34" },
      { name: "WTI Crude Oil", value: "$70.27", unit: "/bbl", open: "70.43", high: "70.87", low: "70.11" },
      { name: "Natural Gas", value: "$3.1710", unit: "/MMBtu", open: "3.1710", high: "3.1790", low: "3.1590" },
      { name: "Gold", value: "$4,008", unit: "/oz", open: "4,032", high: "4,037", low: "3,955" },
      { name: "Silver", value: "$58.32", unit: "/oz", open: "58.77", high: "59.03", low: "57.06" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "Hang Seng", close: "22,753", open: "23,008", range: "22,685 – 23,087", region: "Asia" },
      { name: "KOSPI", close: "8,578", open: "8,417", range: "8,221 – 8,583", region: "Asia" },
      { name: "Nikkei 225", close: "70,642", open: "70,086", range: "69,302 – 70,642", region: "Asia" },
      { name: "Sensex", close: "76,557", open: "77,006", range: "76,455 – 77,037", region: "Asia" },
      { name: "Shanghai Comp.", close: "4,082", open: "4,058", range: "4,052 – 4,082", region: "Asia" },
      { name: "EUR / USD", close: "1.1401", open: "1.1430", range: "1.1399 – 1.1430", region: "Currencies" },
      { name: "GBP / USD", close: "1.3235", open: "1.3258", range: "1.3232 – 1.3262", region: "Currencies" },
      { name: "USD / CNY", close: "6.7796", open: "6.7868", range: "6.7795 – 6.7925", region: "Currencies" },
