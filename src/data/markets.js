...
export const marketsData = {
  ...
  lastUpdated: "26 June 2026, 6:14 PM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$73.07", change: "-9.33%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$69.72", change: "-10.09%", direction: "down" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$4,066", change: "-1.91%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$58.86", change: "-11.16%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.34", change: "+4.57%", direction: "up" },
      { name: "USD / PKR", prev: "278.00", current: "277.92", change: "Flat", direction: "flat" },
      { name: "EUR / USD", prev: "1.1480", current: "1.1423", change: "-0.49%", direction: "down" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$73.05", unit: "/bbl", open: "75.02", high: "75.46", low: "72.47" },
      { name: "WTI Crude Oil", value: "$69.70", unit: "/bbl", open: "71.44", high: "71.86", low: "68.96" },
      { name: "Natural Gas", value: "$3.3440", unit: "/MMBtu", open: "3.2670", high: "3.3750", low: "3.2610" },
      { name: "Gold", value: "$4,066", unit: "/oz", open: "4,044", high: "4,081", low: "3,998" },
      { name: "Silver", value: "$58.84", unit: "/oz", open: "58.03", high: "59.58", low: "56.13" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "CAC 40", close: "8,365", open: "8,410", range: "8,355 – 8,421", region: "Europe" },
      { name: "DAX", close: "24,640", open: "24,849", range: "24,626 – 24,870", region: "Europe" },
      { name: "FTSE 100", close: "10,416", open: "10,530", range: "10,409 – 10,530", region: "Europe" },
      { name: "Stoxx 600", close: "632.25", open: "639.03", range: "632.09 – 639.03", region: "Europe" },
      ...
      { name: "EUR / USD", close: "1.1423", open: "1.1378", range: "1.1357 – 1.1434", region: "Currencies" },
      { name: "GBP / USD", close: "1.3217", open: "1.3197", range: "1.3181 – 1.3229", region: "Currencies" },
      { name: "USD / CNY", close: "6.7896", open: "6.7892", range: "6.7851 – 6.8035", region: "Currencies" },
