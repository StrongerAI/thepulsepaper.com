...
export const marketsData = {
  ...
  lastUpdated: "27 June 2026, 12:42 AM PKT",
  ...
  weekOverWeek: {
    rows: [
      ...
      { name: "Brent crude", prev: "$80.59", current: "$72.58", change: "-9.94%", direction: "down" },
      { name: "WTI crude", prev: "$77.54", current: "$69.26", change: "-10.68%", direction: "down" },
      { name: "Dubai Platts", prev: "$103.15", current: "$79.52", change: "-22.9%", direction: "down" },
      { name: "Gold", prev: "$4,145", current: "$4,083", change: "-1.51%", direction: "down" },
      { name: "Silver", prev: "$66.25", current: "$59.34", change: "-10.44%", direction: "down" },
      { name: "Natural Gas", prev: "$3.20", current: "$3.30", change: "+3.25%", direction: "up" },
      { name: "USD / PKR", prev: "278.00", current: "277.92", change: "Flat", direction: "flat" },
      { name: "EUR / USD", prev: "1.1480", current: "1.1386", change: "-0.82%", direction: "down" },
      { name: "S&P 500", prev: "7,501", current: "7,358", change: "-1.91%", direction: "down" },
      { name: "Petrol (MS)", prev: "Rs 373.78", current: "Rs 299.50", change: "-Rs 74.28", direction: "down" },
      { name: "Gold 24K (tola)", prev: "–", current: "Rs 434,500", change: "–", direction: "flat" },
  ...
  commodities: {
    rows: [
      ...
      { name: "Brent Crude", value: "$72.58", unit: "/bbl", open: "75.02", high: "75.46", low: "71.95" },
      { name: "WTI Crude Oil", value: "$69.25", unit: "/bbl", open: "71.44", high: "71.86", low: "68.56" },
      { name: "Natural Gas", value: "$3.3020", unit: "/MMBtu", open: "3.2670", high: "3.3750", low: "3.2610" },
      { name: "Gold", value: "$4,082", unit: "/oz", open: "4,044", high: "4,112", low: "3,998" },
      { name: "Silver", value: "$59.32", unit: "/oz", open: "58.03", high: "60.00", low: "56.13" },
    // -- /AUTO:commodities-rows --
    ],
  ...
  international: {
    rows: [
      ...
      { name: "Dow Jones", close: "51,814", open: "51,804", range: "51,615 – 52,130", region: "Americas" },
      { name: "Nasdaq", close: "25,338", open: "25,105", range: "25,015 – 25,491", region: "Americas" },
      { name: "S&P 500", close: "7,357", open: "7,313", range: "7,294 – 7,393", region: "Americas" },
      ...
      { name: "EUR / USD", close: "1.1386", open: "1.1378", range: "1.1357 – 1.1434", region: "Currencies" },
      { name: "GBP / USD", close: "1.3197", open: "1.3197", range: "1.3181 – 1.3230", region: "Currencies" },
      { name: "USD / CNY", close: "6.7975", open: "6.7892", range: "6.7851 – 6.8035", region: "Currencies" },
